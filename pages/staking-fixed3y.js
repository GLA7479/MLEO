      ...
      <div className="text-white relative pt-[28px] md:pt-[10px]" style={{ ...bgStyle, minHeight: "100svh" }}>
        ...
        <div className="relative max-w-5xl mx-auto px-3 md:px-4 py-2 md:py-4">
          <div className="flex items-center justify-between mb-2 md:mb-3">
            <div>
              <h1 className="text-lg md:text-xl font-semibold tracking-tight">Stake MLEO — Fixed 3 Years</h1>
              <p className="text-white/70 text-xs">Locked for three years • No early exit • Claim rewards at unlock</p>
            </div>
